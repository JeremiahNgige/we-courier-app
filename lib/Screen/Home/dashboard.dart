                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Get.find<GlobalController>().userEmail ==
                                            null
                                        ? Text('')
                                        : Text(
                                            Get.find<GlobalController>()
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child:
                                      dashboard.deliverymanAssignList.length ==
                                              0
                                          ? Center(
                                              child: Text(
                                              'no_item_found'.tr,
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Row(
                                                                        children: [
                                                                          ...
                                                                          TextButton(
                                                                            onPressed: () =>
                                                                                _launchURL(dashboard.deliverymanAssignList[index].customerPhone.toString()),
                              ...
                              children: [
                                Container(
                                  ...
                                  height:
                                      MediaQuery.of(context).size.height / 1.0,
                                  child:
                                      dashboard.returnToCourierList.length == 0
                                          ? Center(
                                              child: Text(
                                              'no_item_found'.tr,
                                              style: TextStyle(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Row(
                                                                        children: [
                                                                          ...
                                                                          TextButton(
                                                                            onPressed: () =>
                                                                                _launchURL(dashboard.returnToCourierList[index].customerPhone.toString()),
                                                                            style: TextButton.styleFrom(
                                                                                padding: EdgeInsets.zero,
                                                                                minimumSize: Size(50, 30),
                                                                                tapTargetSize: MaterialTapTargetSize.shrinkWrap,
